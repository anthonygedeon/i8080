...
int main(int argc, char **argv) {
    ...
    /* test_run(&state, "test-roms/8080PRE.COM"); */
    test_run(&state, "test-roms/TST8080.COM");
    /* test_run("test-roms/CPUTEST.COM"); */
    /* test_run("test-roms/8080EXM.COM"); */
    /* test_run("test-roms/8080EXER.COM"); */
